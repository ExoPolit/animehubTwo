...
const Welcome = () => {
    return (
        <div className="container-fluid text-center " style={mainStyles}>
            ...
            <a href="/" style={{textDecoration:"none", fontSize:"var(--font-size-lg)"}} >Go to Main</a>
            </button>
            <div className='container-fluid text-center mb-5'>
            <p>Feel Free to watch one of my Favorite fights from Boruto! </p>
            <iframe src={Naruto} frameborder="0" width={1500} height={500} style={iFrameStyles} 
            allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; fullscreen">
            </iframe>
            </div>
            <p >You will notice that i used diffrent styling methods such as:
            </p>
